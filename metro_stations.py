...
class MetroStation:
    ...
    def show_info(self):
        ...
        print(
            f'{self.station_name} station is located at {self.location}. It is currently {open_info}.')
...
# lines: ['1', '2', '3', 'L']
mySubwayStation = SubwayStation(
    '14th street', '14th street and 7th avenue', ['1', '2', '3', 'L'])
mySubwayStation.show_info()
...
my_bus_station = BusStation('NYC Megabus Stop', '34th street and 12th avenue', [
                            'Boston', 'DC', 'Philly'])

my_bus_station.close_station()
my_bus_station.show_info()
my_bus_station.open_station()
my_bus_station.show_info()
